...
describe("RoomListViewViewModel", () => {
    ...
    describe("Initialization", () => {
        it("should initialize with correct snapshot", () => {
            ...
            expect(snapshot.filters.length).toBeGreaterThan(0);
        });
    ...
    describe("Filters", () => {
        it("should toggle filter on", () => {
            ...
            const filters = viewModel.getSnapshot().filters;
            const unreadFilter = filters.find((f) => f.id === "unread");

            expect(unreadFilter?.active).toBe(false);
            ...
            viewModel.onToggleFilter(unreadFilter!);

            const updatedFilters = viewModel.getSnapshot().filters;
            const updatedUnreadFilter = updatedFilters.find((f) => f.id === "unread");
            expect(updatedUnreadFilter?.active).toBe(true);
        ...
        it("should toggle filter off", () => {
            ...
            const updatedFilters = viewModel.getSnapshot().filters;
            const updatedUnreadFilter = updatedFilters.find((f) => f.id === "unread");
            expect(updatedUnreadFilter?.active).toBe(false);
