...
describe("RoomListItemViewModel", () => {
    ...
    describe("Initialization", () => {
        it("should initialize with room data", async () => {
            ...
            expect(snapshot.a11yLabel).toContain("Test Room");
        });
    ...
    describe("Notification state", () => {
        ...
        it("should update when notification state changes", async () => {
            ...
            await new Promise((resolve) => setTimeout(resolve, 0));
            expect(viewModel.getSnapshot().notification.count).toBeUndefined();
    ...
    describe("Room tags", () => {
        it("should reflect favorite tag", async () => {
            ...
            expect(viewModel.getSnapshot().moreOptionsState.isFavourite).toBe(true);
        });
        ...
        it("should reflect low priority tag", async () => {
            ...
            expect(viewModel.getSnapshot().moreOptionsState.isLowPriority).toBe(true);
        });
        ...
        it("should update when room tags change", async () => {
            ...
            await new Promise((resolve) => setTimeout(resolve, 0));
            expect(viewModel.getSnapshot().moreOptionsState.isFavourite).toBe(false);
    ...
    describe("DM detection", () => {
        it("should detect DM rooms", async () => {
            ...
            expect(viewModel.getSnapshot().moreOptionsState.canCopyRoomLink).toBe(false);
        });
        ...
        it("should detect non-DM rooms", async () => {
            ...
            expect(viewModel.getSnapshot().moreOptionsState.canCopyRoomLink).toBe(true);
        });
    });
