...
export interface Settings {
    ...
    "bubbleTail": IBaseSetting<"none" | "telegram" | "telegram-ios" | "imessage">;
...
export const SETTINGS: Settings = {
    ...
    "feature_msc4095_url_preview_bundle": {
        ...
        supportedLevelsAreOrdered: true,
        isFeature: true,
        // Fork: on by default so bridged com.beeper.linkpreviews bundles render (previously a fork-only
        // implementation, now covered by upstream's MSC4095 support).
        default: true,
    },
    /**
    ...
    "bubbleTail": {
        ...
        options: [
            { value: "telegram-ios", label: _td("settings|bubble_tail_telegram_ios") },
