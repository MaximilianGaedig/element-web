...
describe("EventTile", () => {
    ...
    describe("EventTile renderingType: default", () => {
        ...
        it("hides the sender avatar when asked (Telegram-style one-to-one chats)", () => {
            const shown = getComponent({ layout: Layout.Bubble });
            expect(shown.container.querySelector(".mx_BaseAvatar")).toBeInTheDocument();
            shown.unmount();

            const hidden = getComponent({ layout: Layout.Bubble, hideAvatar: true, hideSender: true });
