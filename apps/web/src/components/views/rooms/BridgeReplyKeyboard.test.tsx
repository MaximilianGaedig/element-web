...
import { act, render, screen, within } from "test-utils-rtl";
import userEvent from "@testing-library/user-event";

import { mkEvent, stubClient } from "test-utils";
import BridgeReplyKeyboard, { resetUsedBridgeKeyboards } from "./BridgeReplyKeyboard";
...
import { findActiveReplyKeyboard } from "../../../utils/BridgeButtons";
...
describe("<BridgeReplyKeyboard />", () => {
    ...
    beforeEach(() => {
        ...
        client = stubClient();
        vi.mocked(client.sendTextMessage).mockResolvedValue({ event_id: "$sent" });
    ...
    const renderPanel = (onPlaceholderChange = vi.fn()): ReturnType<typeof render> =>
        render(
