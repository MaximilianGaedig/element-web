...
import { MESSAGE_SEND_STATUS_EVENT_TYPE, parseMessageSendStatus } from "../../../utils/bridge/messageSendStatus";
...
describe("<MessageSendStatus />", () => {
    ...
    it("keeps the newest status and shows remote delivery", () => {
        ...
        expect(container.querySelector(".mx_SendStatus_delivered")).toBeInTheDocument();
    });
    ...
    it("picks up status events already in the timeline", () => {
        ...
        const { container } = renderStatus();
        expect(container.querySelector(".mx_SendStatus_pending")).toBeInTheDocument();
    });
