...
import { type BridgeInfo, describeBridge, getBridgeInfo } from "../../../utils/bridge/bridgeInfo";
...
export function BridgeNetworkHeaderBadge({ room }: { room: Room }): JSX.Element | null {
    ...
    return (
        <Tooltip label={label} placement="right">
            <span className="mx_BridgeHeaderBadge mx_BridgeNetworkHeaderBadge" aria-label={label}>
