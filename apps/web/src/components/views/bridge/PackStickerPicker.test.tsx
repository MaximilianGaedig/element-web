...
import PackStickerPicker from "./PackStickerPicker";
import MatrixClientContext from "../../../contexts/MatrixClientContext";
import { SDKContext } from "../../../contexts/SDKContext";
import { SDKContextClass } from "../../../contexts/SDKContextClass";
import { loadStickerPacks, parseStickerPack } from "../../../utils/bridge/imagePacks";
import { stubClient } from "test-utils";

vi.mock("../../../utils/bridge/imagePacks", async (importOriginal) => ({
    ...(await importOriginal<typeof import("../../../utils/bridge/imagePacks")>()),
...
describe("PackStickerPicker", () => {
    ...
    it("shows packs as tabs, searches and sends the ORIGINAL bridged sticker", async () => {
        ...
        const video = container.querySelector<HTMLVideoElement>("video.mx_PackStickerPicker_media")!;
