...
export function AnimatedVideoLightbox({ src, poster, label, onFinished }: LightboxProps): JSX.Element {
    return (
        <div
            className="mx_AnimatedVideoLightbox"
            onClick={onFinished}
        ...
        >
            ...
            <AccessibleButton
                className="mx_AnimatedVideoLightbox_close"
                onClick={onFinished}
 ...
 */
export default function AnimatedVideoBody(props: IBodyProps): JSX.Element {
    ...
    const className = classNames("mx_AnimatedVideo", {
        ...
        mx_AnimatedVideo_playing: shouldPlay,
    });
        ...
        return (
            <div className={className} style={{ width, height }}>
                <AccessibleButton kind="link" onClick={() => setMediaVisible(true)}>
                    {hints.sticker ? _t("bridge|animated_show_sticker") : _t("bridge|animated_show_gif")}
                </AccessibleButton>
            </div>
        );
    }
    ...
    return (
        ...
        >
            ...
            />
            {!hints.sticker && !shouldPlay && <span className="mx_AnimatedVideo_badge">GIF</span>}
            {hints.bridgedSticker?.pack_url && (
                <a
                    className="mx_AnimatedVideo_pack"
                    href={hints.bridgedSticker.pack_url}
                    target="_blank"
                    rel="noreferrer noopener"
                >
                    {_t("bridge|animated_open_sticker_pack")}
                </a>
            )}
        </div>
    );
