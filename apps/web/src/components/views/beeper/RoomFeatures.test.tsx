...
import MessageComposerFormatBar, { Formatting } from "../rooms/MessageComposerFormatBar";
...
} from "../../../utils/beeper/roomFeatures";
import { dropUnsupportedBridgeFiles } from "../../../utils/beeper/unsupportedFiles";
import { bridgeBlockedActions } from "./BeeperBlockedActionOptions";
...
describe("com.beeper.room_features", () => {
    ...
    it("reaction picker refuses disallowed emoji and explains why", async () => {
        ...
        const quick = (emoji: string): HTMLElement =>
            screen.getAllByRole("checkbox").find((el) => el.textContent?.replace(/\uFE0F/g, "") === emoji)!;
    ...
    it("rejects file types and sizes the network doesn't accept, and tells the user", async () => {
        ...
        const createDialog = vi
            ...
            .mockReturnValue({ finished: Promise.resolve([]), close: vi.fn() } as any);
