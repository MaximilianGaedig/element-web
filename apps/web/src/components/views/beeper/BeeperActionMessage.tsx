 ...
 */
export default function BeeperActionMessage({ mxEvent }: Props): JSX.Element {
    ...
    return (
        <div className="mx_BeeperActionMessage mx_TextualEvent" data-action-type={action?.type}>
            {icon}
