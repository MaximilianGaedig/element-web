...
import { deleteBlockedReason, editBlockedReason } from "../../../utils/beeper/roomFeatures";
 ...
 */
export default function BeeperBlockedActionOptions({
    cli,
    mxEvent,
}: {
    cli: MatrixClient;
        ...
        <>
            {blocked.edit && (
                <IconizedContextMenuOption
                    ...
                    title={blocked.edit}
                    aria-disabled
                    className="mx_BeeperBlockedAction"
                    onClick={() => {}}
                />
            )}
            {blocked.delete && (
