...
import { editBlockedReason, getRoomFeatures, isReactionAllowed } from "../../../../utils/beeper/roomFeatures";
import { getMenuReactions } from "../../../../utils/beeper/telegramMenu";
...
export default function TelegramMessageContextMenu({
    ...
    if (selectedText) {
        add({
            key: "copy",
            icon: "copy",
            label: _t("beeper|telegram_menu_copy_selected"),
    ...
    add(
        !!permalink &&
            isSent && {
                key: "copyMessageLink",
                icon: "link",
                label: _t("beeper|telegram_menu_copy_message_link"),
    ...
    add({ key: "select", icon: "select", label: _t("beeper|telegram_menu_select"), onClick: handlers.select });
    ...
    add(
        isSent &&
            canRedact && { key: "delete", icon: "delete", label: _t("action|delete"), onClick: handlers.redact, danger: true },
    );
