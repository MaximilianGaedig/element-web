...
describe("<RoomSearchView/>", () => {
    ...
    it("should show a spinner before the promise resolves", async () => {
        ...
        await expect(screen.findByTestId("messagePanelSearchSpinner")).resolves.toBeVisible();
    });
    ...
    it("should render results when the promise resolves", async () => {
        ...
        await expect(screen.findByText("Before")).resolves.toBeVisible();
        await expect(screen.findByText("Foo Test Bar")).resolves.toBeVisible();
        await expect(screen.findByText("After")).resolves.toBeVisible();
    });
