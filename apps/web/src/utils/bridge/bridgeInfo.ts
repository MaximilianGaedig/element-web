...
export function describeBridge(info: BridgeInfo): string {
    const type = {
        dm: _t("bridge|room_type_dm"),
        group_dm: _t("bridge|room_type_group_dm"),
        space: _t("bridge|room_type_space"),
        group: _t("bridge|room_type_group"),
    }[info.roomType];
    return _t("bridge|bridged_from", {
